...
## SWBATs
 ...
 - [] Understand the difference between clone and pull
 - [] Understand the purpose of a "feature branch"
 - [] Understand how to avoid merge conflicts
 - [] Understand how to handle merge conflicts when they happen
...
For the purposes of this example, we are using the "Star Wars API" lab.
 ...
 - [] Fork the "template"/"scaffold" from learn-co
 ...
 - [] Download the forked repo into a local directory and change to that directory
...
*Narrative:* Erin makes a new feature branch to get the relevant character movie data from the API.  (Right now it is connecting to the API but not getting any of the relevant info yet.)
 ...
 - [] Make changes to the relevant file
...
- [] Publish (push) changes to remote branch
  - `git push origin api-communicator`
- [] On GitHub, [set up a pull request](https://github.com/hoffm386/apis-and-iteration-seattle-web-career-042219/pull/new/api-communicator)
...
- [] Stage and commit changes
- [] Publish (push) changes to remote branch
- [] On GitHub, set up a pull request
...
- [] Fetch and merge changes from the remote (GitHub) version of the master branch
...
- [] On GitHub, [set up a pull request](https://github.com/hoffm386/apis-and-iteration-seattle-web-career-042219/pull/new/update-readme)
...
- [] Fetch the latest changes from the remote master and try to merge them in
...
- [] Resolve the conflict(s) in the file(s)
...
- [] Publish (push) changes to [remote (GitHub) copy](https://github.com/hoffm386/apis-and-iteration-seattle-web-career-042219/tree/update-readme)
  - `git push origin update-readme`
- [] There is no need to make a new pull request, just merge in the existing one. Now if Erin refreshes the page on the pull request for this branch, the button will turn green.  Now we can approve Erin's pull request!
